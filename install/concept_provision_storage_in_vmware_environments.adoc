...
共享磁盘不是使用 Plug-in for Windows 创建的。您应该创建共享 LUN，然后将其添加到集群中的每个虚拟机。



=== 相关信息

请参阅 https://techdocs.broadcom.com/["Broadcom 技术文档"^]并搜索有关跨物理主机群集虚拟机以及为 Microsoft 群集创建共享 FC RDM LUN 的文档。
