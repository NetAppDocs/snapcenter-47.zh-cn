...
.. 在为选定策略配置计划部分中、单击要配置计划的策略的配置计划列中的*image:../media/add_policy_from_resourcegroup.gif["从资源组添加策略"]。
...
.. 选择要为其配置验证计划的策略、然后单击**image:../media/add_policy_from_resourcegroup.gif["从资源组添加策略"]。
